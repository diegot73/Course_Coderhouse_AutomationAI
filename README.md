...
![Flujo en Make](evidencias/01_flujo_ejecutado_make.png)
![Historial de Ejecuciones](evidencias/02_historial_ejecuciones.png)
![Tabla de Airtable](evidencias/03_registros_airtable.png)
